...
class Test_Config(unittest.TestCase):
     ...
     def test_get_faculty_rating(self):
        #test that the function get_faculty_ratio returns Excellent
        self.assertEqual('Excellent', get_faculty_rating(.91))
     def test_get_faculty_rating(self):
        #test that the function get_faculty_ratio returns Very Good
        self.assertEqual('Very Good', get_faculty_rating(.85))
     def test_get_faculty_rating(self):
        #test that the function get_faculty_ratio returns Good
        self.assertEqual('Good', get_faculty_rating(.71))
     def test_get_faculty_rating(self):
        #test that the function get_faculty_ratio returns Needs Improvement
        self.assertEqual('Needs Improvement', get_faculty_rating(.66))
     def test_get_faculty_rating(self):   
        #test that the function get_faculty_ratio returns Unacceptable
